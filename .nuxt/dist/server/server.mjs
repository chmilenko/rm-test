import { effectScope, reactive, hasInjectionContext, getCurrentInstance, version, unref, inject, toRef, h, nextTick, shallowRef, shallowReactive, isReadonly, ref, markRaw, toRaw, watch, isRef, isReactive, computed, getCurrentScope, onScopeDispose, toRefs, isShallow, defineComponent, provide, Suspense, Transition, useSSRContext, defineAsyncComponent, mergeProps, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, createApp } from "vue";
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./assets/index-10dfa095.js").then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./assets/error-404-0a4b209c.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./assets/error-500-e2a82881.js").then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import("./assets/island-renderer-28e4f834.js").then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
